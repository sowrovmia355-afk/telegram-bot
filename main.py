...
def get_active_countries_from_panel():
    ...
    # ভবিষ্যতে এই এপিআই লিংক ব্যবহার করে প্যানেল থেকে ডাটা আনা যাবে
    return [
        ...
        {"name": "🇺🇬 উগান্ডا (Uganda)", "code": "uganda"}
    ]
...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "check_join":
        ...
        btn = [
            [InlineKeyboardButton("👥 User List & Balance Chart", callback_data="admin_user_list")],
        ...
        text = f"📊 **সকল মেম্বারদের তালিকা ও চার্ট:**\n\n"
        for idx, u in enumerate(users, 1):
            uname = f"@{u[1]}" if u[1] else "No Username"
            text += f"{idx}. UID: `{u[0]}` | {uname} | ৳{u[2]:.2f}\n"
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == "📞 Get Number":
        ...
        await update.message.reply_text("🚦 Live Traf
