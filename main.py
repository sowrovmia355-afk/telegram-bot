...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # প্রথমবার হলে চ্যানেল সাবস্ক্রাইব ও ভেরিফাই অপশন দেখাবে
    buttons = [
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    elif user_text == "🚦 Live Traffic":
        await update.message.reply_text("🚦 Live Traffic: সকল সার্ভার বর্তমানে চালু আছে!")
        return

    elif user_text == "🔐 2FA Code Generator":
        context.user_data['state'] = "waiting_for_2fa"
        btn = [[InlineKeyboardButton("🔙 Back", callback_data="back_main")]]
        await update.message.reply_text(
            "🔐 2FA Code Generator (Facebook / Instagram)\n\n"
    ...
    if state == "waiting_for_2fa":
        ...
        await update.message.reply_text(f"🔍 `{user_text}` রেঞ্জের জন্য নাম্বার খোঁজা হচ্ছে...", parse_mode="Markdown")
        context.user_data['state'] = None
        return
