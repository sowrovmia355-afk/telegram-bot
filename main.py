...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "check_join":
        ...
        btn = [
            ...
            [InlineKeyboardButton("📩 Check OTP", url=OTP_BOT_LINK), InlineKeyboardButton("🔄 Change Country", callback_data="back_to_fb")],
        ...
        btn = [
            ...
            [InlineKeyboardButton("📩 Check OTP", url=OTP_BOT_LINK), InlineKeyboardButton("🔄 Change Country", callback_data="back_to_services")],
            [InlineKeyboardButton("🔙 Back", callback_data="back_to_services")]
        ]
        await query.edit_message_text(msg, reply_markup=InlineKeyboardMarkup(btn), parse_mode="Markdown")
