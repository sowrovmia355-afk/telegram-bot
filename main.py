...
# এখানে আপনার নতুন টোকেনটি বসিয়ে দিতে পারেন (যদি BotFather থেকে নতুন টোকেন নিয়ে থাকেন)
...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "check_join":
        ...
        btn = [[InlineKeyboardButton("🔙 Back", callback_data="admin_stats")]]
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == "📞 Get Number":
        ...
        admin_btns = [
            [InlineKeyboardButton("👥 User Stats & Control", callback_data="admin_stats")]
        ]
