...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "check_join":
        ...
        # ফেসবুক ক্লিক করার পর New Facebook এবং PC Clone অপশন দেখাবে
    ...
    elif data in ["get_num_new_fb", "get_num_pc_clone"]:
        sub_type = "New Facebook" if data == "get_num_new_fb" else "PC Clone"
        demo_number = "+8801700000000"
        
        # নাম্বার, চেক ওটিপি (গ্রুপ লিংক), এবং চেঞ্জ কান্ট্রি বাটন
        msg = f"✅ আপনার {sub_type} নাম্বার রেডি!\n\n📞 নাম্বার: `{demo_number}`\n\nকোড দেখতে নিচের **Check OTP** এ ক্লিক করুন।"
        btn = [
            [InlineKeyboardButton("📩 Check OTP", url=OTP_BOT_LINK), InlineKeyboardButton("🔄 Change Country", callback_data="buy_fb")],
