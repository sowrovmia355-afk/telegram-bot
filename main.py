...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "check_join":
        try:
            ...
            await query.answer("❌ চ্যানেল চেক করতে সমস্যা হচ্ছে। নিশ্চিত করুন যে বট চ্যানেলে এডমিন আছে।", show_alert=True)
            return
    ...
    elif data == "buy_fb" or data == "buy_wa" or data == "buy_tg" or data == "buy_imo" or data == "buy_insta":
        service_name = data.replace("buy_", "").upper()
        demo_number = "+8801700000000"
        # এখানে কোনো ব্যালেন্স বা ওটিপি কাউন্ট নিজে নিজে বাড়বে না।
        msg = f"✅ আপনার {service_name} নাম্বার রেডি!\n\n📞 নাম্বার: `{demo_number}`\n\nকোড রিসিভ হলে নিচের বাটনে চাপ দিন।"
        btn = [
            [InlineKeyboardButton("📩 Check OTP (Demo)", callback_data="demo_otp")],
            [InlineKeyboardButton("🔙 Back", callback_data="back_main")]
        ]
        await query.edit_message_text(msg, reply_markup=InlineKeyboardMarkup(btn), parse_mode="Markdown")

    elif data == "demo_otp":
        # শুধু আসল ওটিপি বা টেস্ট বাটন ভ্যালিডেশন সম্পন্ন হলেই কেবল ২০ পয়সা যোগ হবে
        ...
        await query.answer("📩 সফল! ৳0.20 আপনার ওয়ালেটে যোগ হয়েছে।", show_alert=True)
