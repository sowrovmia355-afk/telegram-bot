...
def get_active_countries_from_panel():
    # ভবিষ্যতে এখানে আপনার প্যানেলের API থেকে লাইভ ভালো ওটিপি আসা দেশের লিস্ট আসবে
    # উদাহরণস্বরূপ ৪-৫টি দেশের ডাইনামিক লিস্ট:
    return [
...
def generate_numbers_by_country(country_code):
    prefix = "+8801" if country_code == "bd" else "+255" if country_code == "tanzania" else "+250"
    numbers = []
    for _ in range(3):
...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "check_join":
        ...
        btn = [
            [InlineKeyboardButton("🔹 New Facebook", callback_data="sub_new_fb")],
    ...
    elif data in ["sub_new_fb", "sub_pc_clone"]:
        sub_type = "New Facebook" if "new_fb" in data else "PC Clone"
        context.user_data["sub_type"] = sub_type
        
        # প্যানেল থেকে ভালো ওটিপি আসা দেশগুলোর ডাইনামিক লিস্ট আনা হচ্ছে
        ...
        sub_type = context.user_data.get("sub_type", "Service")
        ...
        btn = [
            ...
            [InlineKeyboardButton("📩 Check OTP", url=OTP_BOT_LINK), InlineKeyboardButton("🌍 Change Country", callback_data="sub_pc_clone")],
            [InlineKeyboardButton("🔙 Back", callback_data="buy_fb")]
        ]
